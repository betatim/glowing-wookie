...
//    factory->AddVariable( "Dst_MinIPChi2_PRIMARY","Dst_MinIPChi2_PRIMARY", "", 'F' );
   ...
   factory->AddVariable( "-log(minx1_IPCHI2_OWNPV_x2_IPCHI2_OWNPV)","minx1_IPCHI2_OWNPV_x2_IPCHI2_OWNPV", "", 'F' );
...
//       gSystem->Exec("wget http://root.cern.ch/files/tmva_class_example.root");
   ...
   TFile *inputS = TFile::Open( "/afs/cern.ch/work/t/tbird/demu/ntuples/mcemu/mva_emu_2011.root" );
   TFile *inputB = TFile::Open( "/afs/cern.ch/work/t/tbird/demu/ntuples/emu/mva_emu_2011_blind.root" );
...
//    TFile *inputB = TFile::Open( "/afs/cern.ch/work/t/tbird/demu/ntuples/emu/strip_emu_2011_unblind.root" );
   ...
   TTree *signal      = (TTree*)inputS->Get("subTree");
   TTree *signalTrain = signal->CopyTree("RAND>0.5&&Dst_MinIPChi2_PRIMARY>0");
   TTree *signalTest  = signal->CopyTree("RAND<0.5&&Dst_MinIPChi2_PRIMARY>0");
   
   TTree *background      = (TTree*)inputB->Get("subTree");
   TTree *backgroundTrain = background->CopyTree("RAND>0.5&&Dst_MinIPChi2_PRIMARY>0");
   TTree *backgroundTest  = background->CopyTree("RAND<0.5&&Dst_MinIPChi2_PRIMARY>0");
...
//    factory->SetBackgroundWeightExpression( "weight" );
  ...
  // --- OptimizeConfigParamete...: NodeMinEvents = 305
  // --- OptimizeConfigParamete...: Shrinkage = 0.05
   ...
   if (Use["BDTG"]) // Gradient Boost
      factory->BookMethod( TMVA::Types::kBDT, "BDTG",
                           "!H:!V:MaxDepth=3:NTrees=288:NodeMinEvents=305:BoostType=Grad:Shrinkage=0.05:UseBaggedGrad:GradBaggingFraction=0.5:nCuts=20:NNodesMax=5" );
