...
if mumu == True:
    B2JpsiKInput = "AllStreams/Phys/Bs2MuMuLinesBu2JPsiK/Particles"
    myDecay = "[B+ -> (^J/psi(1S) -> ^mu+ ^mu-) ^K+ ]cc"
    dbtag   = "MC11-20111102"
    condtag = "sim-20111111-vc-md100"
    
## Jpsi ee inputs
if mumu==False:
    B2JpsiKInput = "AllStreams/Phys/Jpsi2eeForElectronIDBu2JpsiKLine/Particles"
...
DaVinci().DDDBtag   = dbtag
DaVinci().CondDBtag = condtag
