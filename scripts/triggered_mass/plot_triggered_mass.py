...
chain.Add(directory+"725/output/Demu_NTuple.root")
chain.Add(directory+"726/output/Demu_NTuple.root")
chain.Add(directory+"727/output/Demu_NTuple.root")
#chain.Add(directory+"emu/strip_emu2011.root")
#chain.Add(directory+"emu/strip_emu2012.root")

plots = [
    ( ROOT.kCyan,   "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 0" ),
    ( ROOT.kRed,    "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 0" ),
    ( ROOT.kBlue,   "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 0" ),
    ( ROOT.kYellow, "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 1" ),
    ( ROOT.kMagenta,"Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 0" ),
    ( ROOT.kOrange, "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 1" ),
    ( ROOT.kGreen,  "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 0 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 1" ),
    ( ROOT.kBlack,  "Dst_Hlt2CharmHadD02HH_D02PiPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KPiDecision_TOS == 1 && Dst_Hlt2CharmHadD02HH_D02KKDecision_TOS == 1" ),
  ]
