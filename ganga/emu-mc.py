...
j = Job(name="emu-MC%i-stripped-mag%s%s"%(year,polarity, "-test" if test else ""))
...
lfns = {
  2011 : "/MC/2011/Beam3500GeV-2011-Mag%s-Nu2-Pythia8/Sim08a/Digi13/Trig0x40760037/Reco14a/Stripping20r1NoPrescalingFlagged/27183001/ALLSTREAMS.DST",
  2012 : "/MC/2012/Beam4000GeV-2012-Mag%s-Nu2.5-Pythia8/Sim08a/Digi13/Trig0x409f0045/Reco14a/Stripping20NoPrescalingFlagged/27183001/ALLSTREAMS.DST",
  }

#dataset = j.application.readInputData("../data/emu_2012_%s.py"%polarity)
lfn = lfns[year]%(polarity.capitalize(),)
print "Getting data from:", lfn
dataset = BKQuery(lfn).getDataset()

n_files_per_job = int(len(dataset)/30.) # try to have around 50 jobs
