...
j = Job(name="pipipi0-MC%i-kpistripped-mag%s%s"%(year, polarity, "-test" if test else ""))
...
lfns = {
  ...
  2012 : "/MC/2012/Beam4000GeV-2012-Mag%s-Nu2.5-Pythia8/Sim08e/Digi13/Trig0x409f0045/Reco14a/Stripping20r0p2NoPrescalingFlagged/27163403/ALLSTREAMS.DST",
  }
